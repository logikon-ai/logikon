...
def main(
    ...
    metrics: list[str] = typer.Option(["argmap_size", "argmap_avg_katz_centrality","argmap_attack_ratio"], help="Metrics to compute."),
    ...
    config = ScoreConfig(
        ...
        global_kwargs=dict(
            ...
            generation_kwargs = dict(max_len=3072,),
    ...
    if not os.environ.get("HUGGINGFACEHUB_API_TOKEN"):
        logging.warning("No HUGGINGFACEHUB_API_TOKEN found in environment. Please set one to upload results to huggingface.co.")
